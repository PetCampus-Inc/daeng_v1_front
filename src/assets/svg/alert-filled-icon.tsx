...
interface AlertIconProps extends Omit<IconProps, "color"> {
  colorScheme: "red" | "gray" | "brown" | "orange" | "darkgray";
  rx?: number | string;
}

const AlertFilledIcon = ({ colorScheme, w = 16, h = 16, rx = 4 }: AlertIconProps) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={w} height={h} fill="none" viewBox="0 0 16 16">
      <rect width="16" height="16" fill={colorMap.get(colorScheme)?.[0]} rx={rx} />
      <circle cx="8.001" cy="7.999" r="5.333" fill={colorMap.get(colorScheme)?.[1]} />
      <path
