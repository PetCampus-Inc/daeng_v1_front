const PrincipalIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="none">
      <g clipPath="url(#a)">
        <rect width="80" height="80" fill="#FFF7E1" rx="40" />
        <g filter="url(#b)">
          <path
            fill="#fff"
            fillRule="evenodd"
      ...
      <defs>
        ...
        >
          ...
          <feColorMatrix values="0 0 0 0 0.919775 0 0 0 0 0.81563 0 0 0 0 0.52923 0 0 0 0.3 0" />
          <feBlend
            in2="BackgroundImageFix"
            result="effect1_dropShadow_4270_45218"
          />
          <feBlend
            in="SourceGraphic"
            in2="effect1_dropShadow_4270_45218"
            result="shape"
          />
        </filter>
      </defs>
