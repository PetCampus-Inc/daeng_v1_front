...
const CalendarIcon = ({ w = 16, h = 17, rx = 4, colorScheme = "primary" }: Props) => {
  const colorMap = new Map<string, string[]>([
    ["primary", ["#FFF7E1", "#956F4C", "#525252", "#E4CAB1"]],
    ["gray", ["#F6F6F6", "#858585", "#525252", "#B5B5B5"]]
  ]);
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={w} height={h} viewBox={`0 0 16 17`} fill="none">
      <rect width={16} height={17} rx={rx} fill={colorMap.get(colorScheme)?.[0]} />
      <path
      ...
      <path
        ...
        fill={colorMap.get(colorScheme)?.[3]}
      />
      <path
