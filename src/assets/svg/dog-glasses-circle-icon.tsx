...
const DogGlassesCircleIcon = ({ w = 80, h = 80, colorScheme = "primary" }: Props) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={w} height={h} fill="none" viewBox="0 0 80 81">
      <g clipPath={`url(#${clipPathId})`}>
        ...
        <circle cx={32.5} cy={40.958} r={4.75} stroke="#C8A584" strokeWidth={1.5} />
        <circle cx={45.5} cy={40.958} r={4.75} stroke="#C8A584" strokeWidth={1.5} />
        <path stroke="#C8A584" d="M37 40.958h4" />
      </g>
      <defs>
        ...
        >
          ...
          />
          <feBlend in2="BackgroundImageFix" result="effect1_dropShadow_4244_129162" />
          <feBlend in="SourceGraphic" in2="effect1_dropShadow_4244_129162" result="shape" />
        </filter>
      </defs>
    </svg>
  );
};
export default DogGlassesCircleIcon;
