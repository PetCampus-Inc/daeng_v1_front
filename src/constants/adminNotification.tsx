  ...
  common: [
    {
      ...
      path: (dogId, params) => PATH.ADMIN_ATTENDANCE_INFO(`${dogId}?${params}`),
      icon: <CareDogIcon borderStyle="50%" w={28} h={28} />
    },
    {
      id: 1,
      ...
      path: (dogId, params) => PATH.ADMIN_ATTENDANCE_INFO(`${dogId}?${params}`),
      icon: <CalendarExpireIcon borderStyle="50%" w={28} h={28} />
    },
    {
      id: 2,
    ...
    },
    {
      ...
      text: (alarm) => `견주들에게 ${alarm} 재동의 알림을 전송해 주세요`,
      path: PATH.ADMIN_ATTENDANCE,
    ...
    },
    {
      ...
      path: (dogId) => PATH.ADMIN_CARE_INFO_GALLERY(dogId),
      icon: <AgendaIcon bg={true} w={28} h={28} />
    }
  ] as NotificationItem[]
} as const;
