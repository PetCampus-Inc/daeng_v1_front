...
const DogInfo = () => {
  ...
  return (
    <>
      <Card>
        <AdminTitle name={`requiredItemList.${FIELD_KEYS.DOG_NAME}`} control={control}>
          이름
        </AdminTitle>
        <TextInput name="null" placeholder="강아지 이름을 입력해주세요" disabled />
      </Card>
      <Card>
        <AdminTitle name={`requiredItemList.${FIELD_KEYS.DOG_GENDER}`} control={control}>
          성별
        </AdminTitle>
        <SingleRadio name="null" radiosText={["수컷", "암컷"]} disabled />
      </Card>
      <Card>
        <AdminTitle name={`requiredItemList.${FIELD_KEYS.DOG_SIZE}`} control={control}>
          크기
        </AdminTitle>
        <SingleRadio
          name="null"
      ...
      <Card>
        <AdminTitle name={`requiredItemList.${FIELD_KEYS.DOG_BREED}`} control={control}>
          견종
        </AdminTitle>
        <SearchInputField name="null" placeholder="견종을 선택하는 칸이에요" disabled />
      </Card>
      <Card>
        <AdminTitle name={`requiredItemList.${FIELD_KEYS.DOG_BIRTHDAY}`} control={control}>
          생일
        </AdminTitle>
